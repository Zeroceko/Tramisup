...
import illusScattered from "@/assets/illus-scattered-tasks.png";
import illusMetric from "@/assets/illus-metric-rhythm.png";
import illusIntegration from "@/assets/illus-integration-map.png";
import illusTiramisu from "@/assets/illus-tiramisu-slice.png";
import illusFeatureLaunch from "@/assets/illus-feature-launch.png";
import illusFeatureMetrics from "@/assets/illus-feature-metrics.png";
import illusFeatureGrowth from "@/assets/illus-feature-growth.png";
import illusFeatureAi from "@/assets/illus-feature-ai.png";
import screenLaunch from "@/assets/screen-launch.png";
import screenGrowth from "@/assets/screen-growth.png";
import screenOverview from "@/assets/screen-overview.png";
import iconBrushChecklist from "@/assets/icon-brush-checklist.png";
import iconBrushCheck from "@/assets/icon-brush-check.png";
import iconBrushLightning from "@/assets/icon-brush-lightning.png";
import iconBrushGift from "@/assets/icon-brush-gift.png";
import screenMainDashboard from "@/assets/screen-main-dashboard.png";
import screenDashboard from "@/assets/screen-dashboard.png";
import screenProducts from "@/assets/screen-products-full.png";
import widgetWeeklyMetric from "@/assets/weekly_metric_rythim.png";
import widgetGrowthEngine from "@/assets/growth_engine.png";
import widgetAiPlaniq from "@/assets/AI_PlanIQ_Assistant.png";
import brushStepWorkspace from "@/assets/brush-step-workspace.png";
import brushStepMetrics from "@/assets/brush-step-metrics.png";
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-background/90 backdrop-blur-xl border-b border-border/25 py-3" : "py-5"}`}>
      <div className="container flex items-center justify-between">
        <a href="#" className="flex items-center gap-2.5 no-underline text-foreground">
        ...
        <div className="flex gap-2.5 items-center">
          ...
          <button onClick={() => navigate("/register")} className="bg-charcoal text-primary-foreground px-6 py-2.5 rounded-full text-sm font-bold border-none cursor-pointer hover:-translate-y-0.5 hover:shadow-t-md transition-all active:scale-[0.97] inline-flex items-center gap-1.5">Start free →</button>
        </div>
      </div>
    </nav>
  );
    ...
    <section className="relative overflow-hidden min-h-screen flex items-center justify-center" id="hero-top" style={{ background: "linear-gradient(180deg, #FFD7EF 0%, #FFF5F9 50%, #FFFFFF 100%)" }}>
      <div className="container relative z-10 pt-28 pb-16 text-center">
        <div className="animate-fade-up max-w-[1100px] mx-auto">
          ...
          {/* Email input + CTA */}
          <form onSubmit={(e) => { e.preventDefault(); navigate("/register"); }} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 max-w-[520px] mx-auto mb-6 px-4 sm:px-0" id="hero-form">
            <input
              type="email"
      ...
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-0">
            ...
            <div className="pt-6">
              <button onClick={() => navigate("/register")} className="inline-flex items-center gap-2 bg-charcoal text-primary-foreground px-8 py-3.5 rounded-full text-sm font-bold border-none cursor-pointer hover:-translate-y-1 transition-all">
                Try it free →
              </button>
            </div>
          </div>
      ...
      <div className="container relative z-10">
        <Reveal type="reveal-scale">
          ...
          <div className="flex flex-col items-center gap-5">
            <button onClick={() => navigate("/register")} className="group inline-flex items-center gap-3 border-none px-12 py-5 rounded-full text-xl font-black cursor-pointer hover:scale-105 transition-all duration-300 active:scale-[0.97]" style={{ background: "linear-gradient(135deg, #FFC091, #FFD7EF)", color: "#260A2F" }}>
