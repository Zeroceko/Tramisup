  ...
  return (
    <section className="py-20 lg:py-28" id="overview" style={{ background: "#21231D" }}>
      <div className="container">
        ...
        <div className="flex gap-4 md:gap-6 overflow-x-auto md:overflow-visible pb-4 md:pb-0 snap-x snap-mandatory scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0">
          <Reveal type="reveal-left">
            <div className="rounded-2xl overflow-hidden hover-lift group flex flex-col min-w-[260px] md:min-w-0 md:flex-1 snap-start shrink-0 md:shrink" style={{ background: "#3A341C" }}>
              <div className="p-5 md:p-6 pb-2 flex justify-center">
                <img src={illusScattered} alt={copy.problem.cards[0].alt} className="w-full max-w-[160px] md:max-w-[220px] h-auto object-contain group-hover:scale-110 transition-transform duration-700 ease-out" />
              </div>
          ...
          <Reveal>
            <div className="rounded-2xl overflow-hidden hover-lift group flex flex-col min-w-[260px] md:min-w-0 md:flex-1 snap-start shrink-0 md:shrink" style={{ background: "#320707" }}>
              <div className="p-5 md:p-6 pb-2 flex justify-center">
                <img src={illusMetric} alt={copy.problem.cards[1].alt} className="w-full max-w-[160px] md:max-w-[220px] h-auto object-contain group-hover:scale-110 transition-transform duration-700 ease-out" />
              </div>
              <div className="p-5 md:p-6 pt-2">
          ...
          <Reveal type="reveal-right">
            <div className="rounded-2xl overflow-hidden hover-lift group flex flex-col min-w-[260px] md:min-w-0 md:flex-1 snap-start shrink-0 md:shrink" style={{ background: "#260A2F" }}>
              <div className="p-5 md:p-6 pb-2 flex justify-center">
                <img src={illusIntegration} alt={copy.problem.cards[2].alt} className="w-full max-w-[160px] md:max-w-[220px] h-auto object-contain group-hover:scale-110 transition-transform duration-700 ease-out" />
              </div>
              <div className="p-5 md:p-6 pt-2">
